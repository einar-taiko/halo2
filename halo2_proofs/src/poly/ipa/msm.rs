...
#[derive(Debug, Clone)]
pub struct MSMIPA<'params, 'zal, C: CurveAffine>
where
    'zal: 'params,
{
...
impl<'params, 'zal, C: CurveAffine> MSM<C> for MSMIPA<'params, 'zal, C> {
...
mod tests {
    ...
    fn msm_arithmetic() {
        ...
        let mut a: MSMIPA<EpAffine> = MSMIPA::new(&params, &zal);
        ...
        let mut c: MSMIPA<EpAffine> = MSMIPA::new(&params, &zal);
